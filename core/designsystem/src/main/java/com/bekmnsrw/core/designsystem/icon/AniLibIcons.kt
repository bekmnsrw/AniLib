...
object AniLibIcons {
    ...
    val FavoritesFilled = Icons.Rounded.Favorite
    val FavoritesOutlined = Icons.Rounded.FavoriteBorder
    val ProfileFilled = Icons.Rounded.Person
    val ProfileOutlined = Icons.Rounded.PersonOutline
    val StarRate = Icons.Rounded.StarRate
